...
echo "#######" 
java -jar build/libs/pi-bench-all.jar -mode shared -precision 10000 -num_reps 1 -silent
echo "#######"
...
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 6 -precision 10000 -num_reps 1 -silent
echo "#######"
...
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 18 -precision 10000 -num_reps 1 -silent
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 20 -precision 10000 -num_reps 1 -silent
echo "#######"
...
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 8 -precision 10000 -num_reps 1  -fact_mode cached -silent
echo "#######"
...
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 18 -precision 10000 -num_reps 1  -fact_mode cached -silent
echo "#######"
java -jar build/libs/pi-bench-all.jar -mode parallel -num_threads 20 -precision 10000 -num_reps 1  -fact_mode cached -silent
echo "#######"
